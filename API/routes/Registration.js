...
router.post("/addNewUser",(req,resp) => {
    ...
    const userDetails = {user_name : req.body.user.userName,user_category : req.body.user.userCategory,password : CryptoJS.AES.encrypt(req.body.user.password,"J@NcRfUj").toString(),
